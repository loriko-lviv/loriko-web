  ...
  readonly services: ServiceType[] = [
    {
      ...
      list: [
        ...
        {title: 'Парацентез (розріз барабанної перетинки)', price: '900'},
        {title: 'Репозиція кісток носа з місцевим знечуленням', price: '1100'},
        {title: 'Забір матеріалу на гістологічне обстеження', price: '500'},
        {title: 'Видалення кист мигдалика', price: '450'},
        {title: 'Пункція гайморової пазухи', price: '1100'},
        {title: 'Підслизова кобляційна вазотомія', price: '11500'},
      ]
    },
    {
      type: 'Косметолога',
      list: [
        {title: 'Гігієнічна чиста обличчя для всіх типів шкіри', price: '800'},
        {title: 'Гіг. чистка + пілінг по типу шкіри', price: '1100'},
        {title: 'Гіг. чистка спини', price: '1400'},
        {title: 'Пілінги: мигдалевий, азелаїновий, відбілюючий', price: '700'},
        {title: 'Серединний пілінг YELLOW PEEL (SIMILDIET Іспанія)', price: '1350'},
        ...
        {title: 'Класичний масаж обличчя ', price: '650'},
        {title: 'Лівтинговий, лімфодренажний масаж обличчя', price: '650'},
        ...
        {title: 'Мезотерапія полінуклеотидами препаратом VITARAN (2ml)', price: '4300'},
        ...
        {title: 'Мезотерапія зони навколо очей препаратом REJURAN 1 (1ml)', price: '3400'},
        {title: 'Аугментація губ INTENSE LIPS (NEAUVIA) (1x1 ml)', price: '6000'},
        {
